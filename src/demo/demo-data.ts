...
export const demoTopics: Topic[] = [
  ...
  {
    id: "ai-electronic-friend",
    title: "你愿意把懂你的 AI 当日常伙伴吗？",
    hotScore: 89,
    debateScore: 91,
    evidenceScore: 82,
    controversyLevel: "high",
    discussionPotential: 91,
    reason: "电子好友、隐私边界和情感替代能形成清晰站队，适合刘看山持续追问真实经历。",
  },
  {
    id: "zhihu-circle-social",
    title: "AI 分析社交圈层会打破还是加固信息茧房？",
    hotScore: 86,
    debateScore: 90,
    evidenceScore: 80,
    controversyLevel: "high",
    discussionPotential: 88,
    reason: "社交关系、推荐逻辑和信息茧房天然有反方空间，评论区容易贡献案例。",
  },
  {
    id: "knowledge-distill-creator",
    title: "蒸馏关注人的知识，算创作捷径还是学习入口？",
    hotScore: 81,
    debateScore: 84,
    evidenceScore: 78,
    controversyLevel: "medium",
    discussionPotential: 83,
    reason: "创作者会关心效率，读者会关心原创和引用边界，适合做圈子讨论。",
  },
  {
    id: "ai-companion-privacy",
    title: "AI 记住你的偏好之前，应该先问清哪些边界？",
    hotScore: 80,
    debateScore: 87,
    evidenceScore: 81,
    controversyLevel: "high",
    discussionPotential: 86,
    reason: "偏好记忆、授权、可撤回和隐私越界都是明确可追问的问题。",
  },
  {
    id: "liukanshan-host-ip",
    title: "虚拟 IP 主持讨论，能比普通机器人更有温度吗？",
    hotScore: 76,
    debateScore: 83,
    evidenceScore: 74,
    controversyLevel: "medium",
    discussionPotential: 81,
    reason: "刘看山 IP 唤醒能直接体现项目主题，也能讨论拟人化与可信边界。",
  },
];
