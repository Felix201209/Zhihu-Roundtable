...
export const demoPublishDrafts: Record<string, PublishDraft> = {
  "ai-newcomer-evaluation": {
    ...
    opening: "刘看山把这条热榜拆成了一个更适合开聊的问题：AI 让新人交付变快，但也让管理者更难判断真实能力。你会更看重最后结果，还是更想看到过程证据？",
  ...
  "ai-resume-portfolio": {
    ...
    opening: "刘看山想把这件事抛给创作者和招聘者：作品集不再只是成品展示，也越来越像一次过程说明。AI 参与之后，披露到什么程度才算公平？",
  ...
  "ai-workplace-mentoring": {
    ...
    opening: "刘看山想听听两边的真实经验：AI 改变了新人求助路径，但导师对上下文、风险和组织经验的解释仍然不可替代。导师的价值会变少，还是变贵？",
