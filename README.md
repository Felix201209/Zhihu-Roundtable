...
- `npm run evidence:submission`：只读打印当前 commit、源码包 sha256、截图尺寸和最终外部验收命令，要求工作区干净；提交表或路演备忘可用 `node scripts/print-submission-evidence.mjs --markdown` 输出 Markdown，本地预览可追加 `--allow-dirty`。
